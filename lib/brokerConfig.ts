...
export const BROKER_CONFIGS: Record<string, BrokerConfig> = {
  ...
  fyers: {
    ...
    name: 'fyers',
    displayName: 'Fyers',
    loginUrlTemplate: 'https://api-t1.fyers.in/api/v3/generate-authcode?client_id={apiKey}&redirect_uri={redirectUri}&response_type=code&state=sample',
    apiEndpoint: 'https://api-t1.fyers.in/api/v3',
    requiresApiKey: true,
    requiresApiSecret: true,
    requiresRequestToken: true,
    supportedExchanges: ['NSE', 'BSE', 'NFO', 'MCX'],
