/**
 * POST /api/broker/angel/holdings
 * Get Angel holdings
 * Internal endpoint - called by /api/v1/holdings router
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { getHoldings } = await import('@/lib/angelClient');
    ...
    console.error('Error in Angel holdings:', error);
    return NextResponse.json(
